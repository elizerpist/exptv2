...
/// Resolves a presentation-only growth of each mode's principal detail card.
/// It is separate from mode-local post-content extensions such as Budget's
/// existing chart-first tail.
