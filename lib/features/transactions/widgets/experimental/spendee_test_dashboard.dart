...
class _SpendeeHomeContent extends StatefulWidget {
  const _SpendeeHomeContent({
    ...
    this.mindGlobalRailPresentationListenable,
    this.onMindSumYearSelected,
    required this.onPickSummaryMonth,
    required this.onEditTransaction,
    required this.onDeleteTransactionRequested,
    required this.onVendorSheetRequested,
...
class _StaticValueListenable<T> implements ValueListenable<T> {
  const _StaticValueListenable(this.value);
...
const _disabledMindGlobalRailPresentation = _MindGlobalRailPresentation(
  enabled: false,
  railConfig: _MindSumYearRailConfig(),
  railSurface: _PanelSurface.background,
  railOpacity: 1,
  yearCardEnabled: false,
  yearCardSurface: _PanelSurface.background,
  yearCardOpacity: 1,
  showVolumeBars: false,
  selectedYear: null,
);

const _disabledMindGlobalRailPresentationListenable =
    _StaticValueListenable<_MindGlobalRailPresentation>(
      _disabledMindGlobalRailPresentation,
    );
    ...
    return ValueListenableBuilder<SpendeeHeaderStage>(
      ...
      builder: (context, stage, _) {
        ...
        return ValueListenableBuilder<_MindGlobalRailPresentation>(
          valueListenable:
              widget.mindGlobalRailPresentationListenable ??
              _disabledMindGlobalRailPresentationListenable,
              ...
              builder: (context, constraints) {
                ...
                final mindTimeRail = showMindTimeRail
                    ? _MindGlobalTimeRail(
                        ...
                        onYearPublished: widget.onMindSumYearSelected ?? (_) {},
                      )
                    : null;
