...
| DELIV-04 | user workflow | GitHub/SCIP/journal | App commit is followed by a file-only `[skip ci]` journal commit; exact final app SHA has Actions human APK and exact matching SCIP | Git/Actions/artifact/graph audit | NOT DONE |
