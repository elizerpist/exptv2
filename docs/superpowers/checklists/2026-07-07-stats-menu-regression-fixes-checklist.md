...
| --- | --- | --- | --- | --- | --- |
| STAT-GUARD-001 | User: current implementation must follow the accepted HTML exactly | All stats menu implementation | Implementation starts only after re-reading the mandatory HTML and full acceptance checklist. | Review checklist before coding. | DONE |
| STAT-GUARD-002 | User: focus will be designed later | Stats annual menu | Month focus/detail behavior is not implemented from old regression notes in this pass. | Code review and checklist review. | DONE |
