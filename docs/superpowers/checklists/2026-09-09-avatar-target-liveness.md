...
| AVL-16a Exact renderer evidence | §§9,11.3; actual CI34348237362 K timeout | existing profile collector/validator/tests | Both actual readable Phase A and actual rich Phase B paint are valid nonempty exact paint; zero-row/empty/stale/mismatched paint still fails. Export raw final counts and revisions. | Behavior-preserving predicate extraction, controlled rich-paint red/green, unchanged negative gates, actual next-SHA CI raw JSON | PARTIAL |
