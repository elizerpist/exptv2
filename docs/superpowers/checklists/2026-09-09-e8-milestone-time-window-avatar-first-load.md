...
| E8M-03 | User §§3, 6–8 | SCIP manifest and source/test audit | The exact e8 graph is used only as navigation; source and test consumers are inspected before shared changes. | Manifest/hash verification; graph queries; CURRENT-source audit recorded in forensics. | DONE |
...
| E8M-15 | User §§17–20 | Ubuntu/proot test matrix, CI, human APK, SCIP tooling | Focused/broad validation is honestly reported; final production SHA is pushed, human APK is downloaded/hashed, and separately committed SCIP artifacts index that exact SHA. | Exact commands/results, Actions artifact audit, APK and graph manifests. | DONE |
...
- `DONE`: the final application SHA has a successful exact-SHA Actions run,
  normal human APK delivery, and a separately committed, deterministic SCIP
  graph with matching source provenance.
- `PARTIAL`: source/automated controls preserve the e8 protected surfaces,
  ...
  available.
- `NOT DONE`: scheduler-priority work remains deliberately deferred until a
  frame-correlated measurement justifies it.
...
- GitHub Actions [`Fluvi Verification` run 34317086666](https://github.com/elizerpist/exptv2/actions/runs/34317086666)
  completed successfully for production SHA
  `aa61242c4b933ad9d650361ae1014d67fd184186`: core, curated Flutter,
  normal human APK and A–K automated dashboard profile gates all passed.
- The normal `lib/main.dart` human artifact
  `fluvi_HUMAN_DIAGNOSTIC_aa61242.apk` was downloaded to
  `/storage/emulated/0/Download/fluvi/`; its local SHA-256 and release asset
  digest both equal
  `38fae5e1f463eac1ae987ceed4a0d8a7b2d434e66fb41d1d02f44922ace4ffeb`.
- The separately pushed SCIP commit
  `c8a4996842ec9738c2082a3b953e5ccd7c52cb85` has a deterministic artifact
  tree SHA-256 `ea637c860077c78889fc7b909935a41820321efaf566f98605ce2979169688a5`.
  Its `docs/codegraph/manifest.json` records the same application source SHA
  and raw-index SHA-256
  `215dc25247e686a6468f665ae706d9b530402ae0301dc89194d0223234370837`.
