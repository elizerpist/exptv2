...
| RQP-002 | User, 2026-07-23: Q4 should resemble Q2 | `docs/prototypes/color_lab.html` Q4 block | Q4 contains exactly one Q2-style name pill, a Q2 inline category window with `Lakás` selected, then `Új kategória`, then the existing `Tovább` CTA. | Scoped static assertion and direct markup review | DONE — static suite passed |
