...
| VLOG-04 | §§5, 18 | rail scene cache/core | Rail scene always uses at most preview page size for 1/24/94/1k rows | frozen hashes + full rail matrix | DONE |
...
| VLOG-14 | §35 | verification | Relevant non-golden suite and Ubuntu analysis pass | proot Flutter commands | DONE (314 Flutter tests; analyze clean) |
