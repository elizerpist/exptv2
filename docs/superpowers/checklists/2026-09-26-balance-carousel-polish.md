...
| BCP-07 | User delivery rules | branch, CI, APK | All delivered production changes are committed, pushed, verified online, then the exact human APK is downloaded to `/storage/emulated/0/Download/fluvi` with SHA-256. | Git/Actions/artifact check. | DONE |
