...
- [x] **Step 4: Push the final application SHA as branch tip.** Final application commit `0e97ce1c66bbd8fcce543eb8508c88feb690733e` was pushed before its documentation child. Actions run `35449748738` has `dashboard-paths`, `test-flutter`, `test-core`, and `build-human-diagnostic-apk` green. `run-dashboard-profile` reaches the inherited `frame_timing_headroom is invalid: null` gate, so the workflow is correctly recorded as failed rather than globally green.
- [x] **Step 5: Download and verify the normal human APK.** Release `fluvi-human-diagnostic-0e97ce1` targets final application SHA `0e97ce1c66bbd8fcce543eb8508c88feb690733e`; `/storage/emulated/0/Download/fluvi/fluvi_HUMAN_DIAGNOSTIC_0e97ce1.apk` is `83,678,513` bytes with SHA-256 `1be9548e41e154552872a239351fd1a1fa6221c7cf2862727f60a49bdaae810e`.
- [x] **Step 6: Regenerate exact-source SCIP in the tooling worktree.** Pushed tooling commit `62ece5cc2a0d0be9dfd64118c3f3ecfebba75699` has manifest `source_head=0e97ce1c66bbd8fcce543eb8508c88feb690733e`, raw index SHA-256 `e997b2d0ab11ce4801d98413f15c3d3defa4ee642f83f5a0610122900bb952d6`, and two independent generation manifests with no diff. Final factual journal evidence remains the next docs-only action.
