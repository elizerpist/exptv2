...
Each Q4–Q12 screen renders one edge-to-edge recurring-wizard bottom sheet inside its phone mockup. The sheet uses the existing Q2 geometry contract: `--query-sheet-h: 430px`, `left: 0`, `right: 0`, `bottom: 0`, and `26px 26px 0 0` top radius. It has one grabber, one route header, a scrollable content region, a progress indicator, and a bottom CTA; it must not create nested sheets, dialogs, or extra floating cards.
...
| RPW-005 | User: `a screenben egy sheet legyen, ami olyan magas, mint q2` | Recurring-sheet CSS and nine screen blocks | Every Q4–Q12 screen has exactly one edge-to-edge bottom sheet using Q2's 430px geometry; no nested dialog, popup, or extra sheet exists. | CSS/DOM assertions and HTTP-served visual inspection. | NOT DONE |
