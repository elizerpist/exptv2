...
''';
  ...
  testWidgets('BudgetV2 keeps the Balance shell and mounts B3M-B islands', (
    ...
    for (final key in const <ValueKey<String>>[
      ...
      ValueKey<String>('spendee-budget-v2-avatar-icon-budget-v2-1'),
      ValueKey<String>('spendee-budget-v2-avatar-icon-budget-v2-2'),
      ValueKey<String>('spendee-budget-v2-avatar-icon-budget-v2-3'),
      ValueKey<String>('spendee-budget-v2-avatar-icon-budget-v2-4'),
      ValueKey<String>('spendee-budget-v2-avatar-icon-budget-v2-5'),
