...
void main() {
  group('DashboardGeometryResolver', () {
    ...
    test('derives upstream metric positions instead of independent anchors', () {
    ...
    test('uses one subheader envelope for split and unified modes', () {
      ...
      expect(DashboardModeSpec.balance.subheaderComposition,
          DashboardSubheaderComposition.split);
      expect(DashboardModeSpec.budget.subheaderComposition,
          DashboardSubheaderComposition.split);
      expect(DashboardModeSpec.mind.subheaderComposition,
    ...
    test('interpolates the shared lower stack to the collapsed anchor', () {
      ...
      expect(frame.collapseHandleBounds.top, 392);
